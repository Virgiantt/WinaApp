                ...
                <tbody>
                    ...
                    foreach ($user as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text_center"><img src="<?= base_url('foto/' . $value['foto']) ?>" width="125px" height="125px"></td>
                            <td class="text-center"><?= $value['level'] == '0' ? '<span class="badge badge-success">Admin</span>' : '<span class="badge badge-warning">Petugas</span>' ?></td>
                            <td>
                                <a href="<?= base_url('User/EditData/' . $value['id_user']) ?>" type="button" class="btn btn-warning btn-flat btn-sm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        Hapus User?<b><?= $value['nama_user'] ?></b>
                    </div>
                </div>
